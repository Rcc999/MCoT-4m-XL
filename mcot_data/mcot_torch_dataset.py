...
"""
PyTorch Dataset implementation for MCoT training with MINT paper features.
Handles the JSON format generated by the wget script.
"""
...
class MCoTDataset(Dataset):
    """
    PyTorch Dataset for MCoT training data.
    Handles JSON format from wget script with proper tokenization for 4M model.
    """
    ...
    def __init__(self, 
        ...
        # Setup transforms for each modality
        self.transforms = {}
    ...
    def __getitem__(self, idx: int) -> Dict[str, Any]:
        """
        Get a single MCoT training sample.
        
        Returns:
            Dictionary containing tokenized modalities and step-specific data
        """
        ...
        # Add text modalities for each step
        for step in self.mcot_steps:
            mod_dict[f'text_{step}'] = step_texts[step]
        
        # Add prompt as input text
        mod_dict['text_input'] = sample.get('prompt', 'Generate image')
        
        # Create target based on current step or final response
